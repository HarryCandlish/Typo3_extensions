...
return [
    'ctrl' => [
        ...
        'searchFields' => 'title,price,name',
        'iconfile' => 'EXT:productview/Resources/Public/Icons/tx_productview_domain_model_product.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, price, name, start_date, end_date, featured_event, categories',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, price, name, start_date, end_date, featured_event, categories, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:productview/Resources/Private/Language/locallang_db.xlf:tx_productview_domain_model_product.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'featured_event' => [
            'exclude' => true,
            'label' => 'LLL:EXT:productview/Resources/Private/Language/locallang_db.xlf:tx_productview_domain_model_product.featured_event',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
