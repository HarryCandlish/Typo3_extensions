...
{
    /**
     * @var \Product\Productview\Domain\Model\Product
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Product\Productview\Domain\Model\Product();
    }
     ...
     * @test
     */
    public function getInStoreReturnsInitialValueForBool()
    {
        self::assertSame(
            false,
            $this->subject->getInStore()
        );
    }
     ...
     * @test
     */
    public function setInStoreForBoolSetsInStore()
    {
        $this->subject->setInStore(true);
     ...
     * @test
     */
    public function getSortingReturnsInitialValueForInt()
    {
        self::assertSame(
            0,
     ...
     * @test
     */
    public function setSortingForIntSetsSorting()
    {
    ...
    {
        $category = new \Product\Productview\Domain\Model\Category();
